...
### 🚧 v3.1.0: Notifications (IN PROGRESS)
...
- [x] **Phase 9: Notification Foundation** — Prisma schema migration, config module, notification formatters, and notification transport service with domain wrappers (completed 2026-07-04)
- [x] **Phase 10: Profile UI + User Topic Route** — `updateNtfyTopic` service and route, profile page push notifications section, family topics cards (completed 2026-07-04)
- [x] **Phase 11: Chore-Assigned Trigger** — Wire `notifyChoreAssigned` into `assignment.service.create` with graceful error handling (completed 2026-07-04)
- [x] **Phase 12: Due-Soon Lazy Trigger** — Lazy due-soon ntfy push sweep piggybacking on `assignment.getAll()` (completed 2026-07-04)
...
**Goal**: Add Prisma schema migration, config module, notification formatters, and notification transport service with domain wrappers for ntfy.sh integration
**Depends on**: Phase 8 (Switchover)

**Verification**: 6 UAT tests all passed

### Phase 10: Profile UI + User Topic Route

**Goal**: Add `updateNtfyTopic` service and route, profile page push notifications section, and family topics cards
**Depends on**: Phase 9

**Verification**: 8 UAT tests passed, 2 bugs fixed (navbar link and empty state UX)
...
**Verification**: 3 UAT tests all passed (notification wiring, graceful null-topic/ntfy-disabled/fetch-throw error handling, cold start smoke test)

### Phase 12: Due-Soon Lazy Trigger

**Goal**: Lazy due-soon ntfy push sweep piggybacking on `assignment.getAll()`
**Depends on**: Phase 4 (notification service surface)

**Verification**: 6 UAT tests all passed (sendNtfy boolean return, notifyChoreDueSoon propagation, sweep function filtering, failure isolation, REGULAR+RECURRING coverage)
...
| 9. Notification Foundation           | v3.1.0     | 2/2            | ✅ Complete | 2026-07-04 |
| 10. Profile UI + User Topic Route    | v3.1.0     | 2/2            | ✅ Complete | 2026-07-04 |
| 11. Chore-Assigned Trigger           | v3.1.0     | 1/1            | ✅ Complete | 2026-07-04 |
| 12. Due-Soon Lazy Trigger            | v3.1.0     | 1/1            | ✅ Complete | 2026-07-04 |
